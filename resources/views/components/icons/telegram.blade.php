<!-- https://feathericons.dev/?search=telegram&iconset=brands -->
<svg {{$attributes}} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" class="main-grid-item-icon" fill="none">
