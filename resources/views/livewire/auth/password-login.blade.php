@section('title', ' ورود به پنل مارکتینگ اتومیشن تکنوراه')
            ...
            <div class="mx-auto w-full max-w-sm lg:w-96">
                ...
                <div>
                    ...
                    <h2 class="mt-8 text-2xl font-bold leading-9 tracking-tight text-text-main">
                        ورود به پنل مارکتینگ اتومیشن تکنوراه
                    </h2>
                                ...
                                <x-dialog wire:model="showModal">
                                    ...
                                    <x-dialog.panel>
                                        <div class="prose prose-base mt-5 max-w-none text-text-muted leading-7">
                                            <h3 class="text-text-main">قوانین و مقررات استفاده از پنل مدیریتی تکنوراه</h3>
                                            <p>استفاده از پنل مدیریت تکنوراه به‌منزله پذیرش کامل این قوانین است. هدف از تدوین این موارد، حفظ امنیت، انسجام عملکرد تیم و صیانت از داده‌های کاربران نهایی است.</p>
                                            ...
                                            <ul>
                                                ...
                                                <li>در صورت مشاهده هرگونه دسترسی مشکوک یا غیرمجاز، موظف‌اید سریعاً تیم پشتیبانی تکنوراه را مطلع نمایید.</li>
                                            </ul>

                                            <h4 class="text-text-main">۲. استفاده مسئولانه از سیستم</h4>
                                            <ul>
                                                <li>پنل صرفاً برای وظایف شغلی مرتبط با کمپین‌های مارکتینگ و اتوماسیون مجاز است.</li>
                                            ...
                                            <ul>
                                                <li>استفاده از پنل تکنوراه صرفاً در چارچوب قوانین جاری کشور جمهوری اسلامی ایران مجاز است.</li>
                                                ...
                                                <li>تکنوراه در قبال محتوای ارسال‌شده یا تبعات حقوقی ناشی از آن، هیچ‌گونه مسئولیتی نداشته و در صورت بروز تخلف، دسترسی کاربر به‌صورت موقت یا دائم مسدود خواهد شد.</li>
                                            </ul>
                                            ...
                                            <p>این قوانین ممکن است به‌روزرسانی شوند. لطفاً به‌طور منظم این بخش را بررسی کنید. از همکاری حرفه‌ای شما با تکنوراه سپاسگزاریم.</p>
                                        </div>
                                    </x-dialog.panel>
                                </x-dialog>
                            </div>
