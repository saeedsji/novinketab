...
return array(
    ...
    */
    ...
    "required_without" => ":attribute الزامی است زمانی که :values وارد نشده است ",
    ...
    */
    'attributes' => array(
        ...
        'marketing_channel' => 'نحوه آشنایی',
        'employee_count' => 'تعداد کارمندان',
        'business_name' => 'نام کسب و کار',
        'employee_id' => 'کارمند',
        'link' => 'لینک',
        'grade' => 'نوع مدرک',
        'academy' => 'دانشگاه یا موسسه',
        'start_year' => 'سال شروع',
        'endـyear' => 'سال پایان',
        'company' => 'نام شرکت',
        'company_link' => 'لینک شرکت',
        'work_mode' => 'نحوه کار',
        'work_type' => 'نوع قرارداد',
        'amount' => 'مبلغ',
